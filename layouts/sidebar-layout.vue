  ...
  <div class="flex h-screen bg-base-200">
    ...
    <aside class="w-64 bg-base-100 p-4 flex flex-col text-base-content shadow-lg overflow-y-auto scrollbar-thin">
      ...
      <nav class="mb-auto">
        ...
        <ul>
           <li><NuxtLink to="/libraries" class="flex items-center gap-3 p-2 rounded-lg hover:bg-base-300 mb-1" active-class="!bg-base-300 font-semibold"><Icon name="material-symbols:explore-outline-rounded" class="w-5 h-5" /> Discovery</NuxtLink></li>
